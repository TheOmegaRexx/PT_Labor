...
public class PrimeFactorPrinter {
    ...
    public void printFactorization( long number ){
        ...
        while (number % 2 == 0) {                       // überprüft, ob die Zahl gerade ist
            System.out.print(2 +" * ");                   
            number = number / 2;                        // die Zahl wird durch 2 geteilt
        }

        
        while (divisor <= number) {                     // überprüft, ob der Teiler kleiner oder gleich der Zahl ist
            if (number % divisor == 0) {                // überprüft, ob die Zahl durch den Teiler teilbar ist
                System.out.print(divisor + " ");         
                number = number / divisor;              // die Zahl wird durch den Teiler geteilt
            } else {
                divisor = divisor + 2;                  // der Teiler wird um 2 erhöht, da wir wissen, dass er ungerade sein muss
            }
        }
