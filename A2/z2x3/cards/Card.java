...
public class Card implements Comparable<Card> {
    ...
    final static private long encodedVersion = 2___00001_006___2025_05_03__01L;
    //-----------------------------------------#---^^^^^-^^^---^^^^-^^-^^--^^
     ...
     * <br />
     * Bemerkung:<br />
     * Da es die &quot;Default-Denke&quot; bei einem enum ist, sollte es eigentlich nicht extra erw&auml;hnt werden m&uuml;ssen.
